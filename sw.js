...
self.addEventListener('message', e => {
  ...
  if (e.data.type === 'SANCTION_LOCK') {
    ...
    _writeLock(true);
    // Ne pas recharger la page ici — l'app affiche elle-même l'écran sanction.
    // Le rechargement provoquait une boucle infinie (reload → sanctionPending → lock → reload…)
    return;
  }
